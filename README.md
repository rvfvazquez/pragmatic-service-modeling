...
|---|---|---|
| [pragmatic-compute-expert](./pragmatic-compute-expert/) | Which compute model to use | Lambda, ECS, EKS, Fargate, EC2 |
| [pragmatic-db-expert](./pragmatic-db-expert/) | Which database to use | DynamoDB, DocumentDB, Aurora DSQL |
| [pragmatic-messaging-expert](./pragmatic-messaging-expert/) | Which messaging service to use | SQS, SNS, EventBridge, Kinesis, MSK |
...
1. Download the `.skill` files from the [releases page](../../releases)
2. Open the Cowork app and go to **Plugins → Install from file**
3. Select the `.skill` file for the expert you want

#### Via Claude Code

```bash
# Clone the repository
git clone https://github.com/your-username/pragmatic-service-modeling.git
...
├── pragmatic-compute-expert.skill    ← Compiled skill (for Cowork install)
├── pragmatic-db-expert/              ← Skill: database selection
│   ├── SKILL.md
│   └── references/
│       └── aws-databases.md
├── pragmatic-db-expert.skill
├── pragmatic-messaging-expert/       ← Skill: messaging service selection
│   ├── SKILL.md
│   └── references/
│       └── aws-messaging.md
├── pragmatic-messaging-expert.skill
└── examples/
    ├── README.md
    ├── compute/
...
|---|---|---|
| [pragmatic-compute-expert](./pragmatic-compute-expert/) | Qual modelo de compute usar | Lambda, ECS, EKS, Fargate, EC2 |
| [pragmatic-db-expert](./pragmatic-db-expert/) | Qual banco de dados usar | DynamoDB, DocumentDB, Aurora DSQL |
| [pragmatic-messaging-expert](./pragmatic-messaging-expert/) | Qual serviço de mensageria usar | SQS, SNS, EventBridge, Kinesis, MSK |
...
1. Baixe os arquivos `.skill` na [página de releases](../../releases)
2. Abra o Cowork e vá em **Plugins → Instalar do arquivo**
3. Selecione o arquivo `.skill` do expert desejado

#### Via Claude Code

```bash
# Clone o repositório
git clone https://github.com/seu-usuario/pragmatic-service-modeling.git
